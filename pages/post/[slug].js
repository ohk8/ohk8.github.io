...
export default function Post({ recordMap, categories }) {
    ...
    return (
        <div className="bg-white min-h-screen flex flex-col">
            ...
            <nav className="sticky top-0 z-[100] px-8 py-6 bg-white/80 backdrop-blur-md max-w-[900px] mx-auto w-full">
            ...
            <main className="max-w-[900px] w-full mx-auto pb-16 flex-grow">
